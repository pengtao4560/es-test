## MySQL索引的查看创建和删除
[MySQL索引的查看创建和删除 原文链接](http://blog.chinaunix.net/uid-25063573-id-3032578.html)

1．索引作用
在索引列上，除了上面提到的有序查找之外，数据库利用各种各样的快速定位技术，能够大大提高查询效率。特别是当数据量非常大，
查询涉及多个表时，使用索引往往能使查询速度加快成千上万倍。
